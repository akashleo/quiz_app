...
import {FlagFilled,CheckCircleFilled,ClockCircleFilled} from '@ant-design/icons';
                    ...
                    <Row className='dashboard-content'>
                        ...
                        <Col span={18}>
                            <div className='user-details'>
                                <h2 className='user-name'>Protyush Mukherjee</h2>
                                <p className='user-level'>Bonus booster 24lv</p>
                            </div>
                            <div className="user-progress">
                                <Progress percent={70} showInfo={false} strokeColor={"#C4C4C4"}/>
                            </div>
                        ...
                        <Row className='achivement-featured'>
                            <Col span={12}>
                                    <div className='achivement'>
                                        ...
                                        <div className='achivement-progress'>
                                            <Progress percent={30} size="small" showInfo={false} strokeColor={"#C4C4C4"} />
                                        </div>
                                    </div>
                                    <div className='achivement-badge'>
                                        <Row justify="space-between">
                                            <Col span={8}> <Image src={badge3}
                                                                    width={50}
                                                                    height={50} />
                                                            <p>Comeback</p>
                                            </Col>
                            ...
                            <Col span={12}>
                                ...
                                <Row gutter={[16, 16]} className='featured' style={{padding: "5%"}}>
